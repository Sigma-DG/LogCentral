...
GO
/****** Object:  Table [dbo].[Users]    Script Date: 2019-06-10 4:37:46 PM ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Users]') AND type in (N'U'))
DROP TABLE [dbo].[Users]
GO
/****** Object:  Table [dbo].[Log]    Script Date: 2019-06-10 4:37:46 PM ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Log]') AND type in (N'U'))
DROP TABLE [dbo].[Log]
GO
/****** Object:  Table [dbo].[Device]    Script Date: 2019-06-10 4:37:46 PM ******/
...
GO
INSERT [dbo].[Log] ([Id], [UtcTime], [LocalTime], [Title], [Section], [LogType], [Latitude], [Longitude], [Username], [Device], [Descriptions]) VALUES (N'b1e83450-cefc-481f-942d-1186aeb9c9cb', CAST(N'2019-06-10 20:20:55.430' AS DateTime), CAST(N'2019-06-10T16:20:55.4300000+00:00' AS DateTimeOffset), N'Log3', N'SQL Server', 0, NULL, NULL, N'user1', N'f8e5c6cd-5b48-49d4-b3f1-1c5dcb8a8445', N'Few descriptions')
GO
INSERT [dbo].[Log] ([Id], [UtcTime], [LocalTime], [Title], [Section], [LogType], [Latitude], [Longitude], [Username], [Device], [Descriptions]) VALUES (N'bff3cc4a-6a10-4eed-b288-2372a98ac11e', CAST(N'2019-06-10 20:21:01.490' AS DateTime), CAST(N'2019-06-10T16:21:01.4900000+00:00' AS DateTimeOffset), N'Log4', N'SQL Server', 0, NULL, NULL, N'user2', N'42dc83c5-ed9f-4a8d-a53c-b83f54351ab8', N'Few descriptions')
GO
INSERT [dbo].[Log] ([Id], [UtcTime], [LocalTime], [Title], [Section], [LogType], [Latitude], [Longitude], [Username], [Device], [Descriptions]) VALUES (N'ff39276e-59a2-485b-8e92-5cfa8dd69ef9', CAST(N'2019-06-10 20:21:04.710' AS DateTime), CAST(N'2019-06-10T16:21:04.7100000+00:00' AS DateTimeOffset), N'Log5', N'SQL Server', 0, NULL, NULL, N'user2', N'42dc83c5-ed9f-4a8d-a53c-b83f54351ab8', N'Few descriptions')
GO
INSERT [dbo].[Log] ([Id], [UtcTime], [LocalTime], [Title], [Section], [LogType], [Latitude], [Longitude], [Username], [Device], [Descriptions]) VALUES (N'31e5b19e-8fbc-49a7-be38-96e4ba4c7401', CAST(N'2019-06-10 20:20:31.130' AS DateTime), CAST(N'2019-06-10T16:20:31.1300000+00:00' AS DateTimeOffset), N'Log1', N'SQL Server', 0, NULL, NULL, N'user1', N'f8e5c6cd-5b48-49d4-b3f1-1c5dcb8a8445', N'Few descriptions')
GO
INSERT [dbo].[Log] ([Id], [UtcTime], [LocalTime], [Title], [Section], [LogType], [Latitude], [Longitude], [Username], [Device], [Descriptions]) VALUES (N'095dd8d8-4058-4465-8e23-b231f13c79b4', CAST(N'2019-06-10 20:20:52.357' AS DateTime), CAST(N'2019-06-10T16:20:52.3530000+00:00' AS DateTimeOffset), N'Log2', N'SQL Server', 0, NULL, NULL, N'user1', N'c6ee866b-c781-4bd3-badf-b7fcdadb551a', N'Few descriptions')
GO
INSERT [dbo].[Users] ([Username], [Title], [FirstName], [LastName], [RegisterationUtcDate], [Descriptions]) VALUES (N'user1', N'Mr.', N'John', N'Snow', CAST(N'2019-06-10 20:17:12.553' AS DateTime), NULL)
GO
INSERT [dbo].[Users] ([Username], [Title], [FirstName], [LastName], [RegisterationUtcDate], [Descriptions]) VALUES (N'user2', N'Mrs.', N'Jamie', N'Lannister', CAST(N'2019-06-10 20:17:30.193' AS DateTime), NULL)
GO
